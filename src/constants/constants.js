...
export const projects = [
  {
    title: 'Autonomous Path Mapping Bot',
    description: "Designed an Autonomous Bot that uses a feed from an overhead camera to apply Image Processing and move the boxes present in the arena to their final location.",
    image: '/images/PIXELATE.png',
    tags: ['OpenCV', 'Python', 'Numpy', 'Path Planning'],
